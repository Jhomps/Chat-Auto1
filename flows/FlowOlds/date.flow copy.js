...
const dateFlow = addKeyword(EVENTS.ACTION)
    .addAnswer("¿Qué día te viene bien para agendar? 📅", { capture: true })
...
const confirmationFlow = addKeyword(EVENTS.ACTION)
    .addAnswer("¿Te parece bien la fecha propuesta? Solo responde con ‘si’, ‘no’, o indica otra fecha, por favor. 😊", { capture: true },
        async (ctx, ctxFn) => {
